  ...
  return (
    <div className=" comtainer ">
      ...
      <CardGroup classNome="row-cols-1 row-cols-md-3 g-4  " >
        ...
        <Card>
          <Card.Img variant="top" src="https://cdn.pixabay.com/photo/2015/09/04/23/28/wordpress-923188__480.jpg" />
          <Card.Body>
            <Card.Title>Card title</Card.Title>
            <Card.Text>
        ...
        <Card>
          <Card.Img variant="top" src="https://cdn.pixabay.com/photo/2020/01/26/20/14/computer-4795762__340.jpg" />
          <Card.Body>
            <Card.Title>Card title</Card.Title>
            <Card.Text>
              This is a wider card with supporting text below as a natural
